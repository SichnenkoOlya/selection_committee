                    ...
                    <article class="blog_item">
                        <div class="row">
                            <div class="col-lg-3 col-md-12">
                                <figure>
                                    <a class="hover_effect h_blue" href="${pageContext.request.contextPath}/mainController?command=SHOW_DETAIL_FACULTY&facultyId=${faculty.facultyId}">
                                        <img src="${faculty.imagePath}" class="img-responsive" alt="Image">
                                    </a>
                                </figure>
                            </div>
...
<form action="${pageContext.request.contextPath}/mainController" method="post">
    ...
    <input type="hidden" name="facultyId" value="1"/>
    <input type="submit" name="commit" value="Бюджет">
</form>
